...
// 1. IMPORT THE GLOBAL CART HOOK SO THE GRID BUTTON WORKS DIRECTLY
...
export default function ProductGrid() {
  ...
  // 2. DESTRUCTURE THE ADDTOCART ACTION HERE
          ...
          {currentItems.map((product) => {
            ...
            return (
              ...
              >
                ...
                {/* Typography Metadata & Button Actions Layout */}
                <div className="flex flex-col text-left space-y-2">
                  ...
                  {/* 3. PERMANENT ADD TO CART BUTTON BELOW DETAILS */}
                  {/* clicking this will NOT trigger the product page link redirect */}
                  <button
                    onClick={(e) => {
                      e.preventDefault(); // STOPS LINK NAVIGATION
                      e.stopPropagation(); // STOPS CLICK BUBBLING Up
                      addToCart({
                        id: product.id,
                        name: product.name,
                        price: product.price,
